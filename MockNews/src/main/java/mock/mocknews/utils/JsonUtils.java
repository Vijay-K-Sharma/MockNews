...
import mock.mocknews.ui.ShowErrorDialogAndCloseApp;
    ...
    public void parseJson(final String jsonData){
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                if(null == NewsUtils.getsMockNewsHolder()){
                    NewsUtils.setNewsFeedHolder(new MockNewsHolder());
                }
                for(int i=0;i<NewsData.length;i++){
                    NewsUtils.getsMockNewsHolder().addNewsFeed(new NewsData());
                }
                ...
                for(int index=0 ; index < NewsData.length;index++){
                    ...
                    NewsUtils.getsMockNewsHolder().updateFeed(index,singleNewsData);
            ...
            Log.d(TAG,"MockNewsActivity - parseJson -------- Error parsing jSon:"+e.getMessage());
            e.printStackTrace();
