...
import mock.mocknews.ui.MockNewsActivity;
...
public class CustomAdapter extends BaseAdapter {
    ...
    public CustomAdapter(Context context, Activity activity) {
        mContext = context;
        mList = NewsUtils.getsMockNewsHolder().getNewsDataList();
        if(activity instanceof MockNewsActivity){
            mActivity = activity;
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if(mActivity instanceof MockNewsActivity){
                viewHolder.title.setText(((MockNewsActivity) mActivity).getNewsItem(position).title);
                viewHolder.description.setText(((MockNewsActivity) mActivity).getNewsItem(position).description);
            }
